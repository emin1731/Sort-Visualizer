...
const data = [
  ...
  },
  {
    ...
    algorithm: "gnome",
    description:
      "(Gnome sort) Bubble Sort is the simplest sorting algorithm that works by repeatedly swapping the adjacent elements if they are in the wrong order. This algorithm is not suitable for large data sets as its average and worst-case time complexity is quite high.",
    complexity: {
      title: "quadratic",
      average: "O(n2)",
      best_case: "O(n)",
  ...
  },
  {
    ...
    algorithm: "shaker",
    description:
      "(Shaker sort) Bubble Sort is the simplest sorting algorithm that works by repeatedly swapping the adjacent elements if they are in the wrong order. This algorithm is not suitable for large data sets as its average and worst-case time complexity is quite high.",
    complexity: {
      title: "quadratic",
      average: "O(n2)",
      best_case: "O(n)",
  ...
  },
  {
    ...
    algorithm: "oddeven",
    description:
      "(Odd even sort) Bubble Sort is the simplest sorting algorithm that works by repeatedly swapping the adjacent elements if they are in the wrong order. This algorithm is not suitable for large data sets as its average and worst-case time complexity is quite high.",
    complexity: {
      title: "quadratic",
      average: "O(n2)",
      best_case: "O(n)",
    ...
    <>
      <ThemeProvider theme={theme === "dark" ? DarkMode : LightMode}>
        ...
        <Header
          ...
          themeIcon={theme}
          onSwitchSound={switchSound}
          soundIcon={localStorage.getItem("sound")}
        />
        <HashRouter>
          <Routes>
            <Route
